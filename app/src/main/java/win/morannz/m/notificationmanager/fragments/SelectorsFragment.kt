 ...
 * [SelectorsFragment.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [SelectorsFragment.newInstance] factory method to
...
class SelectorsFragment : Fragment() {
    ...
    override fun onStart() {
        ...
        btn_add_selector.setOnClickListener {
            listener?.onFragmentInteraction(C.NEW_NOTIFICATION_SELECTOR, C.NO_DATA)
        }
    }
